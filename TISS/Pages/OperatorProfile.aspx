<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="OperatorProfile.aspx.cs" Inherits="TISS.Pages.OperatorProfile" %>
            ...
            <div class="col-sm-6">
                <div class="col-sm-12">
                    <div class="panel panel-info" dir="rtl">
                        ...
                        <div class="panel-body">
                            <div>
                                <asp:Label ID="lblONumber" runat="server" CssClass="text-primary" Font-Names="IRANSans" Text="شماره پرسنلی" Style="margin-top: 5%"></asp:Label>
                                <asp:TextBox ID="txtONumber" runat="server" CssClass="form-control" placeHolder="شماره پرسنلی" Font-Names="IRANSans" Style="margin-top: 1%; margin-bottom: 5%"></asp:TextBox>
